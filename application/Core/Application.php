...
class Application
{
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            $this->url_controller = isset($_REQUEST["page"]) ? $_REQUEST["page"] : null;
            $this->url_action = isset($_REQUEST["action"]) ? $_REQUEST["action"] : null;
            $this->url_params = isset($_REQUEST["param"]) ? [$_REQUEST["param"]] : [];
        }
    }
}
